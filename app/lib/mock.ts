...
export const tracks: Track[] = [
  {
    ...
    completionRate: 54,
    lessons: [
      { id: "s1", title: "开篇·一支笔之外", summary: "写作不是技巧，是看世界的方式。", durationText: "08:24", status: "published", views: 38 },
      { id: "s2", title: "第一日·见我", summary: "从一个清晨开始，把第一念落到纸上。", durationText: "09:12", status: "published", views: 31 },
      { id: "s3", title: "第二日·见物", summary: "练习观察一件物，把它写成一篇 300 字短札。", durationText: "11:02", status: "published", views: 24 },
      { id: "s4", title: "第三日·见人", summary: "把今日遇到的一个人写下来——不评价，只描述。", durationText: "—", status: "uploading", progress: 64 },
      { id: "s5", title: "第四日·见事", summary: "今日的一件事，从五个角度复写。", durationText: "—", status: "transcoding", progress: 38 },
      { id: "s6", title: "第五日·见念", summary: "心里冒出来的一念，捕住它，落墨。", durationText: "10:30", status: "draft", views: 0 },
      { id: "s7", title: "第六日·见旧", summary: "重读一年前的自己——只写感受，不改。", durationText: "—", status: "failed" },
      { id: "s8", title: "第七日·见今", summary: "把这七日写成一封给自己的信。", durationText: "12:45", status: "draft", views: 0 },
    ],
  },
];
...
export const members: Member[] = [
  { id: "m1", name: "李 ·· 茜", phone: "138****2204", source: "CSV · 知识星球", joinedAt: "5/02", courseCount: 6, playbackMinutes: 482, lastActive: "刚刚", bound: true },
  { id: "m2", name: "周 ·· 屿", phone: "—", source: "邀请短链", joinedAt: "5/12", courseCount: 3, playbackMinutes: 192, lastActive: "12 分钟前", bound: false },
  { id: "m3", name: "陈 ·· 鹿", phone: "139****8810", source: "单加", joinedAt: "5/03", courseCount: 5, playbackMinutes: 391, lastActive: "26 分钟前", bound: true },
  { id: "m4", name: "吴 ·· 默", phone: "186****4119", source: "CSV · 小报童", joinedAt: "5/01", courseCount: 7, playbackMinutes: 612, lastActive: "1 小时前", bound: true },
  { id: "m5", name: "苏 ·· 砚", phone: "—", source: "邀请短链", joinedAt: "5/16", courseCount: 1, playbackMinutes: 12, lastActive: "2 小时前", bound: false },
  { id: "m6", name: "顾 ·· 行", phone: "135****0327", source: "单加", joinedAt: "4/28", courseCount: 6, playbackMinutes: 540, lastActive: "今早", bound: true },
  { id: "m7", name: "卫 ·· 棠", phone: "151****6620", source: "CSV · 知识星球", joinedAt: "5/06", courseCount: 4, playbackMinutes: 268, lastActive: "昨日", bound: true },
  { id: "m8", name: "—", phone: "—", source: "邀请短链 · 未绑定", joinedAt: "5/15", courseCount: 2, playbackMinutes: 38, lastActive: "昨日", bound: false, anonymous: true },
  { id: "m9", name: "金 ·· 砚", phone: "153****0044", source: "单加", joinedAt: "4/22", courseCount: 8, playbackMinutes: 720, lastActive: "3 日前", bound: true },
];
...
export const studentLessons: StudentLesson[] = [
  ...
  { n: 2, id: "s3", t: "第二日 · 见物", d: "11:02", status: "playing", progress: 64 },
