...
export function AuthEntry({
  ...
  const [email, setEmail] = useState(
    mode === "register" ? "hello@xingchunge.com" : "",
  );
  ...
  return (
    ...
    >
      <div style={{ width: "100%", maxWidth: 460 }}>
        ...
        <div
          className="tz-card"
          style={{ padding: 18, boxShadow: "var(--shadow-1)" }}
        >
                ...
                >
                  ...
                  <input
                    ...
                    onChange={(event) => {
                      ...
                      setName(nextValue);
                      if (!slugTouched)
                        setSlug(suggestSlug(nextValue) || "xingchunge");
                    }}
                    placeholder="例如：醒春阁"
                    required
                  />
            ...
            {error && (
              <div
                style={{
                  ...
                  borderRadius: 6,
                  background:
                    "color-mix(in oklch, var(--seal) 10%, var(--paper))",
                  color: "var(--seal)",
                  fontSize: 11.5,
                }}
              >
