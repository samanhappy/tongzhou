  ...
  async function handleCreate() {
    ...
    try {
      if (!apiBase) {
        ...
        setNotice(
          "离线演示模式：课程已临时创建在当前页面。真正落库请接上 API_BASE。",
        );
        setShowCreate(false);
        return;
      }
            ...
            <div style={{ flex: 1, minWidth: 0 }}>
              ...
              >
                <span>
                  ...
                  课时 （{track.lessonsPublished} 发布 /{" "}
                  {track.lessonsTotal - track.lessonsPublished} 草稿）
                </span>
                <span>
                  <b
                    style={{
