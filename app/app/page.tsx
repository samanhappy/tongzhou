    ...
    >
      ...
      >
        ...
        >
          ...
          <span
            className="tz-serif"
            style={{ fontSize: 17, fontWeight: 500, letterSpacing: "0.06em" }}
          >
            同舟
          </span>
          <span
...
function SiteHero() {
  return (
    <section
      id="product"
      style={{ padding: "84px 0 78px", position: "relative", overflow: "hidden" }}
    >
      <div
        aria-hidden
        style={{
        ...
        >
          ...
          <div>
            ...
            >
              ...
              >
                免费开通空间{" "}
                <I.chevR size={13} style={{ opacity: 0.6 }} />
              </Link>
              <Link
                href="/demo"
                className="tz-btn"
...
// 4 · 30 分钟链路
// ─────────────────────────────────────────────────────────────
type ThumbKind = "form" | "brand" | "upload" | "publish" | "link";

function SiteOnboarding() {
  const steps: { n: number; t: string; dur: string; d: string; visual: ThumbKind }[] = [
            ...
            {steps.map((s, i) => (
              <div key={s.n} style={{ position: "relative", paddingTop: 0 }}>
                ...
                <div style={{ paddingLeft: 4 }}>
                  <h4
                    className="tz-serif"
                    style={{ margin: "0 0 6px", fontSize: 16, fontWeight: 500 }}
                  >
                    {s.t}
                  </h4>
                  <p
...
function StepThumb({ kind }: { kind: ThumbKind }) {
    ...
    return (
      <div style={base}>
        ...
        <div style={{ display: "flex", gap: 6 }}>
          {["#1a4d4a", "#7a2e1f", "#1e3a8a", "#0c0c0c", "#c2410c"].map(
            (c, i) => (
              <div
                key={c}
                style={{
                  ...
                  background: c,
                  border:
                    i === 0 ? "2px solid var(--ink)" : "2px solid transparent",
  ...
  if (kind === "upload")
    return (
      <div style={base}>
        ...
        <div
          style={{
            border: "1.2px dashed var(--paper-edge)",
            borderRadius: 5,
            padding: "10px",
            fontSize: 9.5,
            color: "var(--ink-3)",
      ...
      <div style={base}>
        ...
        {(
          ...
          >
            ...
            <span
              className="tz-mono"
              style={{ fontSize: 8, color: "var(--ink-3)" }}
            >
...
function SiteMetering() {
  const rows = [
    {
      k: "members.active_count",
      n: "月活学员",
      desc: "学员在本月内有任意访问即视为活跃",
      smp: "实时",
    },
    {
      k: "courses.count",
      n: "发布课程",
      desc: "status = published 的课程取本月最大值",
      smp: "实时",
    },
    {
      k: "storage.bytes",
      n: "视频存储",
      desc: "OSS 用量每日 03:00 快照，月内取平均",
      smp: "每日",
    },
    {
      k: "playback.minutes",
      n: "播放分钟",
      desc: "播放器 30 秒心跳累加，当月加总",
      smp: "30 秒",
    },
  ];
  return (
        ...
        >
          ...
          >
            ...
            >
              ...
              <br />
              学员观看
              <span style={{ color: "var(--accent-soft)" }}>永远</span>
              不被打断。
            </h3>
            <div
              style={{
            ...
            >
              {(
                ...
                <div
                  ...
                  style={{
                    display: "grid",
                    gridTemplateColumns: "84px 1fr 88px",
                    alignItems: "center",
                    gap: 10,
                    paddingTop: 10,
                    borderTop: i
...
function SitePricing() {
  const tiers: Tier[] = [
    ...
    },
    {
      ...
      cta: "联系我们",
      ctaHref: "mailto:hello@tongzhou.app",
      ctaStyle: "outline",
    },
  ];
  return (
    <section id="pricing" style={{ padding: "96px 0" }}>
      <SiteContainer>
            ...
            const ctaBg =
              t.ctaStyle === "primary"
                ...
                : t.ctaStyle === "accent"
                  ? "var(--accent)"
                  : "transparent";
            const ctaColor = t.ctaStyle === "outline" ? "var(--paper)" : "#fff";
            const ctaBorder =
              t.ctaStyle === "outline"
        ...
        >
          所有方案 · 学员观看不被中断 · 已上传视频永远可播 · 计量事件流可重算 ·
          月底对账
        </div>
      </SiteContainer>
    </section>
...
function SiteCase() {
  return (
    <section
      id="case"
      style={{ padding: "96px 0", background: "var(--paper-deep)" }}
    >
      <SiteContainer>
        <SectionLead
          num="05 · 在 用"
              ...
              >
                {(
                  [
                    [
                      "D + 0",
                      "邮箱注册 → 上传 4 个视频 → 发布第一门课。",
                      "28 min",
                    ],
                    [
                      "D + 2",
                      "用 CSV 导入了 47 位老学员（从知识星球）。",
                      "—",
                    ],
                  ...
                  <div
                    ...
                    style={{
                      ...
                      paddingBottom: 12,
                      borderBottom:
                        i < 3 ? "1px dashed var(--paper-edge)" : "none",
                    }}
                  >
                    <span
                      className="tz-mono"
                      style={{ fontSize: 11.5, color: "var(--accent-deep)" }}
                    >
                      {d}
                    </span>
      ...
      >
        ...
        <div
          style={{
            ...
            padding: "14px 14px",
            background:
              "linear-gradient(180deg, var(--accent-ink), oklch(0.32 0.05 162))",
            color: "#fff",
            borderRadius: 10,
            position: "relative",
            overflow: "hidden",
        ...
        >
          ...
          <div style={{ fontSize: 9.5, opacity: 0.78, marginTop: 4 }}>
            从见我，到见今。
          </div>
          <div
            style={{
            ...
            >
              ...
              <div style={{ flex: 1, minWidth: 0 }}>
                <div
                  style={{
                    fontSize: 10,
                    fontWeight: s === "playing" ? 500 : 400,
                    color:
                      s === "playing" ? "var(--accent-deep)" : "var(--ink)",
                  }}
                >
                  {t}
                </div>
          ...
          {qs.map((it, i) => (
            <div
              ...
              style={{
                ...
                borderTop: "1px solid var(--paper-line)",
                borderBottom:
                  i >= qs.length - 2 ? "1px solid var(--paper-line)" : "none",
              }}
            >
              <h4
                className="tz-serif"
...
function SiteCTA() {
  return (
    ...
    >
      ...
      >
        <span className="tz-stamp" style={{ background: "var(--seal)" }}>
          舟
        </span>
        <h2
          className="tz-serif"
        ...
        >
          ...
          <a
            href="mailto:hello@tongzhou.app"
            style={{
              padding: "14px 22px",
...
function SiteFooter() {
  const cols: { t: string; l: { label: string; href: string }[] }[] = [
    ...
    },
    {
      t: "方案",
      l: [
        { label: "Freemium", href: "#pricing" },
        { label: "Pro", href: "#pricing" },
        { label: "Team / 私有部署", href: "mailto:hello@tongzhou.app" },
        { label: "教育优惠", href: "mailto:hello@tongzhou.app" },
      ],
    },
    {
      t: "资源",
            ...
            <div key={c.t}>
              ...
              >
                {c.l.map((x) => (
                  ...
                  >
                    {x.href.startsWith("mailto:") || x.href.startsWith("#") ? (
                      <a href={x.href} style={{ color: "inherit" }}>
                        {x.label}
                      </a>
                    ) : (
                      <Link href={x.href} style={{ color: "inherit" }}>
                        {x.label}
                      </Link>
                    )}
                  </li>
